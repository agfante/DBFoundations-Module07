...
-- 2024-08-14,agfante,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_agfante')
	 Begin 
	  Alter Database [Assignment07DB_agfante] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_agfante;
	 End
	Create Database Assignment07DB_agfante;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_agfante;
